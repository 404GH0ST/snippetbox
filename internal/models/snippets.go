...
func (m *SnippetModel) Latest() ([]Snippet, error) {
	...
	// Must defer after error check, if not then it will try to close a nil resultset
	defer rows.Close()
	...
	// Always check errors after rows.Next() iteration. It's important to call this -
